...
// vvp and greps for "ERROR:" on stdout (see test/Makefile elab-fail-* targets).
//=============================================================================
...
// MC timing / write-ack > 255 (RTL uses 8-bit counters)
module tb_elab_fail_mcwide;
    wire aclk, aresetn;
    assign aclk = 1'b0;
    assign aresetn = 1'b0;
    axi4_to_dfi_bridge #(
...
// DFI_INIT_START_CYCLES < 0 (16-bit counter load in RTL)
module tb_elab_fail_dfiinit_neg;
    wire aclk, aresetn;
    assign aclk = 1'b0;
    assign aresetn = 1'b0;
    axi4_to_dfi_bridge #(
        .DFI_INIT_START_CYCLES(-1)
    ) dut (
        .axi_aclk(aclk), .axi_aresetn(aresetn),
        .s_axi_awid(4'b0), .s_axi_awaddr(32'b0), .s_axi_awlen(8'b0), .s_axi_awsize(3'd3),
        .s_axi_awburst(2'b01), .s_axi_awlock(1'b0), .s_axi_awcache(4'b0), .s_axi_awprot(3'b0),
...
// DFI_INIT_START_CYCLES > 65535
module tb_elab_fail_dfiinit_ovf;
    wire aclk, aresetn;
    assign aclk = 1'b0;
    assign aresetn = 1'b0;
    axi4_to_dfi_bridge #(
        .DFI_INIT_START_CYCLES(70000)
    ) dut (
        .axi_aclk(aclk), .axi_aresetn(aresetn),
        .s_axi_awid(4'b0), .s_axi_awaddr(32'b0), .s_axi_awlen(8'b0), .s_axi_awsize(3'd3),
        .s_axi_awburst(2'b01), .s_axi_awlock(1'b0), .s_axi_awcache(4'b0), .s_axi_awprot(3'b0),
