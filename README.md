...
cd test
mkdir -p build
iverilog -g2001 -Wall -o build/sim.vvp ../src/cdc_fifo_lib.v ../src/mc_dfi_scheduler.v ../src/axi4_bridge_frontend.v ../src/dfi_adapter.v ../src/axi4_to_dfi_bridge.v ../src/tb_axi4_to_dfi_bridge.v
vvp build/sim.vvp
